...
async(Void, citel,text) => {
    let zx = text.length;
    if (zx < 8) {
        let {data} = await axios.get(`http://api.brainshop.ai/get?bid=177318&key=jj9hZmtlwELzCvJP&uid=[${citel.sender.split("@")[0]}]&msg=hi im`);
