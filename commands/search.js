...
const {fetchJson,cmd, tlang,fancytext,botpic } = require('../lib')
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            Void.sendMessage(citel.chat, { image: { url: random.male }, caption: `*╰┈➤ 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 ${sigma_config.botname}*` }, { quoted: citel })
            Void.sendMessage(citel.chat, { image: { url: random.female }, caption: `*╰┈➤ 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 ${sigma_config.botname}*` }, { quoted: citel })
        }
    )
    //---------------------------------------------------------------------------
cmd({
